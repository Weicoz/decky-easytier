...
const Content = () => {
                    ...
                    return (SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsxs("div", { style: {
                                ...
                                overflow: "hidden",
                                        ...
                                        width: "100%",
                                                ...
                                                whiteSpace: "nowrap",
                                                maxWidth: "180px",
                                            }, children: peer.hostname || (isLocal ? t("peers_local_host") : t("peers_unknown_host")) }), SP_JSX.jsx("span", { style: {
                                                fontSize: "10px",
                                                padding: "2px 6px",
                                                borderRadius: "4px",
                                                background: isLocal
                                                ...
                                                fontWeight: "bold",
                                                flexShrink: 0,
                                            }, children: peer.cost.toUpperCase() })] }), SP_JSX.jsxs("div", { style: {
                                        fontSize: "11px",
                                        color: "#dcdedf",
                                        display: "flex",
                                        flexDirection: "column",
    ...
    return (SP_JSX.jsxs("div", { className: "decky-easytier-container", style: {
            width: "100%",
            maxWidth: "100%",
            boxSizing: "border-box",
            overflowX: "hidden",
      ...
      ` }), SP_JSX.jsx(DFL.Focusable, { style: {
                    display: "flex",
                    gap: "6px",
